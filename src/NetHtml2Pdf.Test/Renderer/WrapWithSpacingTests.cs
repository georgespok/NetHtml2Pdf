...
public class WrapWithSpacingTests
{
    ...
    public void ApplySpacing_Order_MarginParentThenBorderElementThenPaddingElement()
    {
        ...
        // Act
        var result = TestWrapWithSpacing.ApplySpacing(parentContainer, elementContainer, parentStyles, elementStyles);
    ...
    public void ApplySpacing_NestedContainers_CumulativeParentPadding()
    {
        ...
        // Act
        var result = TestWrapWithSpacing.ApplyNestedSpacing(grandparentContainer, parentContainer, elementContainer,
    ...
    public void ApplySpacing_VariousValues_AppliesCorrectly(double marginTop, double? marginRight, double marginBottom,
        double? marginLeft,
        ...
        double paddingTop, double? paddingRight, double paddingBottom, double? paddingLeft)
    {
        ...
        var wrapWithSpacing = new TestWrapWithSpacing();
        var parentStyles =
            CssStyleMap.Empty.WithMargin(BoxSpacing.FromSpecific(marginTop, marginRight, marginBottom, marginLeft));
        var elementStyles = CssStyleMap.Empty
    ...
    {
        public static TestResult ApplySpacing(TestContainer parent, TestContainer element,
        ...
        public static TestResult ApplyNestedSpacing(TestContainer grandparent, TestContainer parent,
