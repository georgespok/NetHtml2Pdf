...
public class DisplayClassifierTests
{
    ...
    public void Classify_SemanticBlockElements_ReturnsBlock()
    {
        ...
        // Act & Assert
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Div), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Section), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Paragraph), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Heading1), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Heading2), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Heading3), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Heading4), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Heading5), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Heading6), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.UnorderedList), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.OrderedList), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.ListItem), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Table), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Block);
    }
    ...
    public void Classify_SemanticInlineElements_ReturnsInline()
    {
        ...
        // Act & Assert
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Span), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Inline);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Strong), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Inline);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Bold), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Inline);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Italic), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Inline);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.Text), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Inline);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.LineBreak), CssStyleMap.Empty)
            .ShouldBe(DisplayClass.Inline);
    }
    ...
    public void Classify_ExplicitCssDisplay_OverridesSemanticDefault()
    {
        ...
        // Act & Assert
        TestDisplayClassifier.Classify(span, CssStyleMap.Empty.WithDisplay(CssDisplay.Block))
            .ShouldBe(DisplayClass.Block);
        TestDisplayClassifier.Classify(span, CssStyleMap.Empty.WithDisplay(CssDisplay.InlineBlock))
            .ShouldBe(DisplayClass.InlineBlock);
        TestDisplayClassifier.Classify(span, CssStyleMap.Empty.WithDisplay(CssDisplay.None))
            .ShouldBe(DisplayClass.None);
    }
    ...
    public void Classify_DisplayNone_ReturnsNone()
    {
        ...
        // Act
        var result = TestDisplayClassifier.Classify(div, CssStyleMap.Empty.WithDisplay(CssDisplay.None));
    ...
    public void Classify_ListItemElement_DefaultsToBlock()
    {
        ...
        // Act
        var result = TestDisplayClassifier.Classify(listItem, CssStyleMap.Empty);
    ...
    public void Classify_TableSubElements_HandledViaTableContext()
    {
        ...
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.TableHead), CssStyleMap.Empty)
            .ShouldNotBe(DisplayClass.None);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.TableBody), CssStyleMap.Empty)
            .ShouldNotBe(DisplayClass.None);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.TableSection), CssStyleMap.Empty)
            .ShouldNotBe(DisplayClass.None);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.TableRow), CssStyleMap.Empty)
            .ShouldNotBe(DisplayClass.None);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.TableHeaderCell), CssStyleMap.Empty)
            .ShouldNotBe(DisplayClass.None);
        TestDisplayClassifier.Classify(new DocumentNode(DocumentNodeType.TableCell), CssStyleMap.Empty)
            .ShouldNotBe(DisplayClass.None);
    }
    ...
    public void Classify_UnknownNodeType_DefaultsToBlockWithWarning()
    {
        ...
        // Act
        var result = TestDisplayClassifier.Classify(unknownNode, CssStyleMap.Empty);
    ...
    public void Classify_UnsupportedCssDisplayValue_FallsBackToSemanticDefault()
    {
        ...
        // Act
        var result = TestDisplayClassifier.Classify(div, CssStyleMap.Empty); // No explicit display set
    ...
    public void Classify_ExplicitCssDisplayBlockOnSpan_ReturnsBlock()
    {
        ...
        // Act
        var result = TestDisplayClassifier.Classify(span, styles);
    ...
    public void Classify_ExplicitCssDisplayInlineBlockOnDiv_ReturnsInlineBlock()
    {
        ...
        // Act
        var result = TestDisplayClassifier.Classify(div, styles);
    ...
    public void Classify_VariousNodeTypes_ReturnsCorrectSemanticDefaults(DocumentNodeType nodeType,
        DisplayClass expected)
    {
        // Arrange
        var classifier = new TestDisplayClassifier();
        ...
        // Act
        var result = TestDisplayClassifier.Classify(node, CssStyleMap.Empty);
    ...
    {
        public static DisplayClass Classify(DocumentNode node, CssStyleMap style)
        {
