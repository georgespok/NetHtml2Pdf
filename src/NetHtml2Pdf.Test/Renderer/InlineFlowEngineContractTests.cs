...
public class InlineFlowEngineContractTests
{
    ...
    public void ProcessInlineContent_TextNode_EmitsTextWithStyle()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, node, style);
    ...
    public void ProcessInlineContent_SpanNode_TraversesChildren()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, span, style);
    ...
    public void ProcessInlineContent_StrongNode_AppliesBoldStyleToChildren()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, strong, style);
    ...
    public void ProcessInlineContent_BoldNode_AppliesBoldStyleToChildren()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, bold, style);
    ...
    public void ProcessInlineContent_ItalicNode_AppliesItalicStyleToChildren()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, italic, style);
    ...
    public void ProcessInlineContent_LineBreakNode_EmitsEmptyLine()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, br, style);
    ...
    public void ProcessInlineContent_InlineBlockNode_UsesSimplifiedPath()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, inlineBlock, style);
    ...
    public void ProcessInlineContent_StyleInheritance_BoldItalicUnderlineFontSizeColor()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, text, parentStyle);
    ...
    public void ProcessInlineContent_NestedElements_CumulativeStyleInheritance()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, outer, style);
    ...
    public void ProcessInlineContent_DisplayNoneInChild_SkipsChildOnly()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, parent, style);
    ...
    public void ProcessInlineContent_ComplexNesting_MaintainsOrderAndInheritance()
    {
        ...
        // Act
        ProcessInlineContent(textDescriptor, root, style);
    ...
    private static void ProcessTextNode(TestTextDescriptor textDescriptor, DocumentNode node, InlineStyleState style)
    {
    ...
    private static void ProcessInlineBlock(TestTextDescriptor textDescriptor, DocumentNode node, InlineStyleState style)
    {
