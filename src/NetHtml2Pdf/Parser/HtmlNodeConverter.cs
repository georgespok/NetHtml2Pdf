...
{
    private static readonly IReadOnlyDictionary<string, DocumentNodeType> ElementTypeMap =
        new Dictionary<string, DocumentNodeType>(StringComparer.OrdinalIgnoreCase)
        {
